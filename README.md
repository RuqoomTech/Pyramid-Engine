...
| Tests | 22 CTest targets: 5 image/utility tests plus API linkage and focused graphics/platform coverage |
...
- OpenGL device, engine-owned mesh resources, stable mesh identifiers, content-deduplicating mesh and shader-program caches, buffers, vertex arrays, shaders, textures, resize-safe framebuffers, and state caching.
